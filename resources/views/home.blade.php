        ...
        <div class="row">
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_code" class="form-control" placeholder="Supplier Code" value="{{$string}}" readonly>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_group" class="form-control" placeholder="Supplier Group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="address_1" class="form-control" placeholder="Add Address Line 1">
                    @error('address_1')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="address_2" class="form-control" placeholder="Add Address Line 2">
                    @error('address_2')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="period" class="form-control" placeholder="Enter Credit Period">
                    @error('period')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <div class="form-check" name=gst id="gst">
                        ...
                        <input type="radio" name="gst" id="yes" value=1>
                        <label for="no">No</label>
                        <input type="radio" name="gst" id="no" value=0>
                    </div>
                    @error('gst')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
        ...
        $('.myTable').on('click','#add',function() {
            $('.myTable').append(' <tr>'+
                               ...
                               ' <td>'+
                                ...
                                '<td>'+
                                    '<div class="form-group">'+
                                        '<input type="text" name="name" class="form-control" placeholder="Enter Mobile">'+
                                    '</div>'+
                                '</td>'+
